...
public class AppPreferences {
    ...
    public void setRootStatus(int rootStatus) {
        editor.putInt(KeyIsRooted, rootStatus).commit();
    }
    ...
    public void setPrimaryColorPref(Integer res) {
        editor.putInt(KeyPrimaryColor, res).commit();
    }
    ...
    public void setFABColorPref(Integer res) {
        editor.putInt(KeyFABColor, res).commit();
    }
    ...
    public void setNavigationBlackPref(Boolean res) {
        editor.putBoolean(KeyNavigationBlack, res).commit();
    }
    ...
    public void setCustomFilename(String res) {
        editor.putString(KeyCustomFilename, res).commit();
    }
    ...
    public void setSortMode(String res) {
        editor.putString(KeySortMode, res).commit();
    }
    ...
    public void setCustomPath(String path) {
        editor.putString(KeyCustomPath, path).commit();
    }
    ...
    public void setHiddenApps(Set<String> hiddenApps) {
        editor.remove(KeyHiddenApps).commit();
        editor.putStringSet(KeyHiddenApps, hiddenApps).commit();
    }
