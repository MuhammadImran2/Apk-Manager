...
import com.devpk.ApkManager.activities.AboutActivity;
import com.devpk.ApkManager.activities.SettingsActivity;
import com.devpk.ApkManager.adapters.AppAdapter;
...
public class UtilsUI {
    ...
    public static Drawer setNavigationDrawer(
            Activity activity, final Context context, Toolbar toolbar, final AppAdapter appAdapter
            , final AppAdapter appSystemAdapter, final AppAdapter appFavoriteAdapter
            , final AppAdapter appHiddenAdapter, final RecyclerView recyclerView) {
